...
export default function DataOrchestrationPage({ onBack }: DataOrchestrationPageProps) {
  ...
  const saveFlow = () => {
    if (currentFlow) {
      setTemplates([currentFlow, ...templates])
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Flow Designer */}
      {isDesigning && currentFlow && (
        <Card className="border-2 border-dashed border-blue-300">
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                <CardTitle>流程设计器</CardTitle>
                <CardDescription>拖拽组件到画布中设计您的数据处理流程</CardDescription>
              </div>
              <div className="flex gap-2">
          ...
          <CardContent>
            <div className="grid grid-cols-4 gap-6">
              ...
              <div className="space-y-4">
                <h4 className="font-semibold text-gray-900">组件库</h4>
              ...
              <div className="col-span-3">
                  ...
                  {currentFlow.nodes.length === 0 ? (
                    ...
                    <div className="relative w-full h-full">
                      {currentFlow.nodes.map((node) => (
                        <div
                          key={node.id}
                          className="absolute bg-white border-2 border-blue-300 rounded-lg p-3 shadow-md min-w-32"
                ...
                <div className="mt-4 grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    <Label>流程分类</Label>
                    <Select
                      value={currentFlow.category}
                      onValueChange={(value) => setCurrentFlow({ ...currentFlow, category: value })}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="医学影像">医学影像</SelectItem>
                        <SelectItem value="文本处理">文本处理</SelectItem>
                        <SelectItem value="图像处理">图像处理</SelectItem>
                        <SelectItem value="数据清洗">数据清洗</SelectItem>
