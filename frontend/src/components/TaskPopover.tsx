...
export default function TaskPopover() {
    ...
    return <Popover placement='topLeft' content={<div className='w-[500px]'>
                ...
                <div className="space-y-2">
                    {tasks.map((task) => (
                        <div key={task.id} className="p-3 border border-gray-100 rounded-lg hover:bg-gray-50">
                            <div className="space-y-2">
                                <div className="flex items-center justify-between">
                                    <h4 className="font-medium text-sm truncate flex-1">{task.name}</h4>
                                ...
                                {task.scheduleConfig.type === "scheduled" && (
                                    <div className="text-xs text-gray-500 bg-gray-50 p-2 rounded">
                                        ...
                                        {task.nextExecution && <div>下次执行: {task.nextExecution}</div>}
                                        <div>
