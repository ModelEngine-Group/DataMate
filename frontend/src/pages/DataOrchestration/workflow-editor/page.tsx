        ...
        <div className="relative" onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
            ...
            >
                ...
                <CardContent className="p-4 space-y-4">
                    ...
                    {/* Parameters Table */}
                    <div>
                        <h4 className="font-medium text-gray-900 mb-3">搜索参数设置</h4>
...
export default function WorkflowEditor({ onBack, onSave, initialWorkflow }: WorkflowEditorProps) {
    ...
    const onConnect = useCallback(
        (params: Connection) => {
            ...
            // Create the new edge with enhanced styling
            const newEdge = {
                ...params,
                                ...
                                <CardContent className="p-4">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <h3 className="font-medium text-gray-900 mb-1">{nodeType.name}</h3>
                                            <p className="text-sm text-gray-600 leading-relaxed">{nodeType.description}</p>
