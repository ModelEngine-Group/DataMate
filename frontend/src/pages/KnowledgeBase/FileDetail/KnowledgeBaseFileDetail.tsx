...
import { Card, Button, Tabs, Modal, Breadcrumb, Tag, Spin, Empty, Alert, Badge, Input, message } from "antd";
import { queryKnowledgeBaseFileDetailUsingGet, deleteKnowledgeBaseChunk } from "@/pages/KnowledgeBase/knowledge-base.api";
...
const KnowledgeBaseFileDetail: React.FC = () => {
  ...
  const handleEditChunk = (chunk: RagChunk) => {
          ...
          <Card
            ...
            extra={
              <div className="flex items-center gap-1">
                ...
                <Button size="small" type="text" onClick={() => handleEditChunk(chunk)}>
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <EditChunkModal
        open={!!editingChunk}
        chunkId={editingChunk?.id ?? null}
        knowledgeBaseId={knowledgeBaseId}
        initialText={editingChunk?.text ?? ""}
        initialMetadata={editingChunk?.metadata ?? {}}
