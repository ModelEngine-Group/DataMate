...
class ImageOCRExtractorOperator:
    """
    ...
    def _classify_image(self, image: Image.Image) -> tuple[str, float]:
        ...
        if scores:
            ...
            return (best, best_confidence) if best_confidence >= 0.3 else ("photo", 0.5)
        return "photo", 0.5
...
def run(image_path: str, language: str = "eng") -> Dict[str, Any]:
    ...
    return ImageOCRExtractorOperator().process(image_path, language)
