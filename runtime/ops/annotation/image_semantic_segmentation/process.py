...
def mask_to_polygons(mask: np.ndarray):
    """
    mask: uint8, shape (H, W), values 0/1
    return: list of polygons, each polygon is [x1,y1,x2,y2,...] 两个数字，一个点
    """
...
# ---------- 类别选择（多选，数字） ----------
TARGET_CLASS_IDS = [0, 2, 5]   # person, car, bus
# 全部类别：TARGET_CLASS_IDS = None
