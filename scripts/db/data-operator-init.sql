...
INSERT INTO t_operator (id, name, description, version, inputs, outputs, runtime, settings, file_name, file_size, metrics, is_star, usage_count, created_by, updated_by, created_at, updated_at) VALUES ('PropertyDataGenerator', '不动产数据生成', '生成不动产信息查询结果数据，包含姓名、证件号、地址、产权信息等', '1.0.0', 'text', 'text', '{"memory":52428800,"cpu":0.1,"gpu":0,"npu":0,"storage":"10MB"}', '{"dataCount":{"name":"生成数据组数","description":"每次执行生成的数据组数","type":"inputNumber","defaultVal":10,"min":1,"max":100,"step":1,"required":true},"outputFormat":{"name":"输出格式","description":"选择输出数据的格式","type":"select","defaultVal":"json","required":true,"options":[{"label":"JSON格式","value":"json"},{"label":"纯文本格式","value":"text"}]},"includeTableData":{"name":"包含表格数据","description":"是否在输出中包含详细的表格数据","type":"switch","defaultVal":"true","checkedLabel":"包含","unCheckedLabel":"不包含","required":false}}', 'inquiry_property_data_generator.tar', 39424, '[{"name":"生成速度","metric":"100 records/sec"}]', null, 3, 'system', 'system', '2026-01-29 19:48:24.198723', '2026-01-29 21:02:24.036798');
INSERT INTO t_operator (id, name, description, version, inputs, outputs, runtime, settings, file_name, file_size, metrics, is_star, usage_count, created_by, updated_by, created_at, updated_at) VALUES ('WordTemplateFiller', 'Word模板填充', '将不动产数据填充到Word模板中，生成查询结果文档', '1.0.0', 'text', 'text', '{"memory":104857600,"cpu":0.2,"gpu":0,"npu":0,"storage":"50MB"}', '{"templatePath":{"name":"模板文件路径","description":"Word模板文件的相对路径（如：templates/不动产信息查询结果模板.docx）","type":"input","defaultVal":"templates/不动产信息查询结果模板.docx","required":true},"dataSource":{"name":"数据来源","description":"选择数据来源：从输入文本解析JSON或使用固定数据","type":"select","defaultVal":"input","required":true,"options":[{"label":"从输入文本解析","value":"input"},{"label":"使用固定数据","value":"fixed"}]},"fixedData":{"name":"固定数据","description":"当数据来源为\"使用固定数据\"时，在此输入JSON格式的数据","type":"input","defaultVal":"","required":false},"outputFormat":{"name":"输出格式","description":"选择输出格式：Word文档或Base64编码","type":"select","defaultVal":"word","required":true,"options":[{"label":"Word文档","value":"word"},{"label":"Base64编码","value":"base64"}]}}', 'inquiry_word_template_filler.tar', 34304, '[{"name":"处理速度","metric":"10 docs/sec"}]', null, 3, 'system', 'system', '2026-01-29 19:48:31.911218', '2026-01-29 21:02:24.036798');
INSERT INTO t_operator (id, name, description, version, inputs, outputs, runtime, settings, file_name, file_size, metrics, is_star, usage_count, created_by, updated_by, created_at, updated_at) VALUES ('WordToImageConverter', 'Word转图片', '将Word文档转换为高质量JPG图片，支持多页文档', '1.0.0', 'text', 'text', '{"memory":209715200,"cpu":0.3,"gpu":0,"npu":0,"storage":"100MB"}', '{"imageDPI":{"name":"图片DPI","description":"图片分辨率DPI，数值越高图片越清晰","type":"slider","defaultVal":300,"min":150,"max":600,"step":50,"required":true},"skipBlankPages":{"name":"跳过空白页","description":"是否自动跳过空白页（大部分区域是白色的页面）","type":"switch","defaultVal":"true","checkedLabel":"跳过","unCheckedLabel":"不跳过","required":false},"outputFormat":{"name":"输出格式","description":"选择输出格式：图片路径或Base64编码","type":"select","defaultVal":"path","required":true,"options":[{"label":"图片路径","value":"path"},{"label":"Base64编码","value":"base64"}]},"maxRetries":{"name":"最大重试次数","description":"Word转PDF失败时的最大重试次数","type":"inputNumber","defaultVal":3,"min":1,"max":5,"step":1,"required":false}}', 'inquiry_word_to_image_converter.tar', 30720, '[{"name":"处理速度","metric":"5 docs/sec"}]', null, 3, 'system', 'system', '2026-01-29 19:48:47.360439', '2026-01-29 21:02:24.036798');
INSERT INTO t_operator (id, name, description, version, inputs, outputs, runtime, settings, file_name, file_size, metrics, is_star, usage_count, created_by, updated_by, created_at, updated_at) VALUES ('RealWorldSimulator', '真实世界模拟', '将电子凭证图片合成到真实场景背景中，支持多种拍摄场景', '1.0.0', 'text', 'text', '{"memory":524288000,"cpu":0.5,"gpu":0,"npu":0,"storage":"200MB"}', '{"sceneMode":{"name":"场景模式","description":"选择处理场景：自动检测或指定场景","type":"select","defaultVal":"auto","required":true,"options":[{"label":"自动检测","value":"auto"},{"label":"正常场景","value":"normal"},{"label":"斜拍场景","value":"tilted"},{"label":"阴影场景","value":"shadow"},{"label":"水印场景","value":"watermark"},{"label":"不完整场景","value":"incomplete"}]},"enableRatioFix":{"name":"启用比例校正","description":"是否启用比例校正以防止图像变形","type":"switch","defaultVal":"true","checkedLabel":"启用","unCheckedLabel":"禁用","required":false},"enableAutoRotate":{"name":"启用自动旋转","description":"是否自动旋转源图以匹配目标方向","type":"switch","defaultVal":"true","checkedLabel":"启用","unCheckedLabel":"禁用","required":false},"outputFormat":{"name":"输出格式","description":"选择输出格式：图片路径或Base64编码","type":"select","defaultVal":"path","required":true,"options":[{"label":"图片路径","value":"path"},{"label":"Base64编码","value":"base64"}]}}', 'inquiry_real_world_simulator.tar', 2378752, '[{"name":"处理速度","metric":"2 docs/sec"}]', null, 3, 'system', 'system', '2026-01-29 19:49:02.024042', '2026-01-29 21:33:52.653198');
INSERT INTO t_operator (id, name, description, version, inputs, outputs, runtime, settings, file_name, file_size, metrics, is_star, usage_count, created_by, updated_by, created_at, updated_at) VALUES ('JsonlGeneratorOps', 'JSON文件生成', '将不动产数据和图片信息组合生成符合JSONL格式的JSON文件', '1.0.0', 'text', 'text', '{"memory":104857600,"cpu":0.1,"gpu":0,"npu":0,"storage":"50MB"}', '{"generationMode":{"name":"生成模式","description":"选择生成模式：单页JSON或多页JSONL","type":"select","defaultVal":"jsonl","required":true,"options":[{"label":"JSONL格式（多页）","value":"jsonl"},{"label":"JSON格式（单页）","value":"json"}]},"includeTableData":{"name":"包含表格数据","description":"是否在JSON中包含表格数据","type":"switch","defaultVal":"true","checkedLabel":"包含","unCheckedLabel":"不包含","required":false},"outputFormat":{"name":"输出格式","description":"选择输出格式：文件路径或JSON内容","type":"select","defaultVal":"path","required":true,"options":[{"label":"文件路径","value":"path"},{"label":"JSON内容","value":"content"}]}}', 'inquiry_jsonl_generator.tar', 30720, '[{"name":"生成速度","metric":"10 records/sec"}]', null, 2, 'system', 'system', '2026-01-29 19:54:05.148912', '2026-01-29 21:02:24.036798');
INSERT INTO t_operator_instance (instance_id, operator_id, op_index, settings_override) VALUES ('7f200fe0-cd7a-4171-b3ad-4aca21b85821', 'PropertyDataGenerator', 1, '{}');
INSERT INTO t_operator_instance (instance_id, operator_id, op_index, settings_override) VALUES ('7f200fe0-cd7a-4171-b3ad-4aca21b85821', 'WordTemplateFiller', 2, '{}');
INSERT INTO t_operator_instance (instance_id, operator_id, op_index, settings_override) VALUES ('7f200fe0-cd7a-4171-b3ad-4aca21b85821', 'WordToImageConverter', 3, '{}');
INSERT INTO t_operator_instance (instance_id, operator_id, op_index, settings_override) VALUES ('7f200fe0-cd7a-4171-b3ad-4aca21b85821', 'RealWorldSimulator', 4, '{}');
INSERT INTO t_operator_instance (instance_id, operator_id, op_index, settings_override) VALUES ('7f200fe0-cd7a-4171-b3ad-4aca21b85821', 'JsonlGeneratorOps', 5, '{}');
INSERT INTO public.t_operator_release (id, version, release_date, changelog) VALUES ('RealWorldSimulator', '1.0.0', '2026-01-29 21:33:52.670785', '["首次发布","支持真实世界模拟功能","支持多种拍摄场景（正常、斜拍、阴影、水印、不完整）","支持自动检测文档角落","支持透视变换和色彩匹配","支持比例校正和自动旋转","支持图片路径和Base64编码两种输出格式"]');
INSERT INTO public.t_operator_release (id, version, release_date, changelog) VALUES ('JsonlGeneratorOps', '1.0.0', '2026-01-29 19:54:05.156394', '["首次发布","支持JSON文件生成功能","支持JSONL格式输出（每行一个JSON对象）","支持单页JSON和多页JSONL两种模式","支持从输入文本解析JSON数据","支持从sample中获取图片路径"]');
INSERT INTO public.t_operator_release (id, version, release_date, changelog) VALUES ('WordToImageConverter', '1.0.0', '2026-01-29 19:48:47.364715', '["首次发布","支持Word转JPG图片功能","支持多页文档处理","支持自动跳过空白页","支持图片DPI配置","支持图片路径和Base64编码两种输出格式"]');
INSERT INTO public.t_operator_release (id, version, release_date, changelog) VALUES ('WordTemplateFiller', '1.0.0', '2026-01-29 19:48:31.918898', '["首次发布","支持Word模板填充功能","支持从输入文本解析JSON或使用固定数据","支持Word文档和Base64编码两种输出格式"]');
INSERT INTO public.t_operator_release (id, version, release_date, changelog) VALUES ('PropertyDataGenerator', '1.0.0', '2026-01-29 19:48:24.201868', '["首次发布","支持生成不动产查询结果数据","支持JSON和纯文本两种输出格式","可配置生成数量和是否包含表格数据"]');

INSERT INTO public.t_operator_category_relation (category_id, operator_id) VALUES ('9eda9d5d-072b-499b-916c-797a0a8750e1', 'PropertyDataGenerator');
INSERT INTO public.t_operator_category_relation (category_id, operator_id) VALUES ('d8a5df7a-52a9-42c2-83c4-01062e60f597', 'PropertyDataGenerator');
INSERT INTO public.t_operator_category_relation (category_id, operator_id) VALUES ('431e7798-5426-4e1a-aae6-b9905a836b34', 'PropertyDataGenerator');
INSERT INTO public.t_operator_category_relation (category_id, operator_id) VALUES ('ec2cdd17-8b93-4a81-88c4-ac9e98d10757', 'PropertyDataGenerator');
INSERT INTO public.t_operator_category_relation (category_id, operator_id) VALUES ('9eda9d5d-072b-499b-916c-797a0a8750e1', 'WordTemplateFiller');
INSERT INTO public.t_operator_category_relation (category_id, operator_id) VALUES ('d8a5df7a-52a9-42c2-83c4-01062e60f597', 'WordTemplateFiller');
INSERT INTO public.t_operator_category_relation (category_id, operator_id) VALUES ('431e7798-5426-4e1a-aae6-b9905a836b34', 'WordTemplateFiller');
INSERT INTO public.t_operator_category_relation (category_id, operator_id) VALUES ('ec2cdd17-8b93-4a81-88c4-ac9e98d10757', 'WordTemplateFiller');
INSERT INTO public.t_operator_category_relation (category_id, operator_id) VALUES ('9eda9d5d-072b-499b-916c-797a0a8750e1', 'WordToImageConverter');
INSERT INTO public.t_operator_category_relation (category_id, operator_id) VALUES ('d8a5df7a-52a9-42c2-83c4-01062e60f597', 'WordToImageConverter');
INSERT INTO public.t_operator_category_relation (category_id, operator_id) VALUES ('431e7798-5426-4e1a-aae6-b9905a836b34', 'WordToImageConverter');
INSERT INTO public.t_operator_category_relation (category_id, operator_id) VALUES ('ec2cdd17-8b93-4a81-88c4-ac9e98d10757', 'WordToImageConverter');
INSERT INTO public.t_operator_category_relation (category_id, operator_id) VALUES ('9eda9d5d-072b-499b-916c-797a0a8750e1', 'JsonlGeneratorOps');
INSERT INTO public.t_operator_category_relation (category_id, operator_id) VALUES ('d8a5df7a-52a9-42c2-83c4-01062e60f597', 'JsonlGeneratorOps');
INSERT INTO public.t_operator_category_relation (category_id, operator_id) VALUES ('431e7798-5426-4e1a-aae6-b9905a836b34', 'JsonlGeneratorOps');
INSERT INTO public.t_operator_category_relation (category_id, operator_id) VALUES ('ec2cdd17-8b93-4a81-88c4-ac9e98d10757', 'JsonlGeneratorOps');
INSERT INTO public.t_operator_category_relation (category_id, operator_id) VALUES ('9eda9d5d-072b-499b-916c-797a0a8750e1', 'RealWorldSimulator');
INSERT INTO public.t_operator_category_relation (category_id, operator_id) VALUES ('de36b61c-9e8a-4422-8c31-d30585c7100f', 'RealWorldSimulator');
INSERT INTO public.t_operator_category_relation (category_id, operator_id) VALUES ('431e7798-5426-4e1a-aae6-b9905a836b34', 'RealWorldSimulator');
INSERT INTO public.t_operator_category_relation (category_id, operator_id) VALUES ('ec2cdd17-8b93-4a81-88c4-ac9e98d10757', 'RealWorldSimulator');
INSERT INTO public.t_clean_template (id, name, description, created_at, updated_at, created_by) VALUES ('7f200fe0-cd7a-4171-b3ad-4aca21b85821', '不动产信息查询结果流水线', '', '2026-01-29 22:05:29.541753', '2026-01-29 22:05:29.541753', null);
