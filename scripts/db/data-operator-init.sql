...
INSERT INTO t_operator (id, name, description, version, inputs, outputs, runtime, settings, file_name, file_size, metrics, is_star, created_by, updated_by)
VALUES
  ('InsuranceImgAugOperator', '社会保险参保图片增强合成算子', '将凭证图片与背景图进行合成，模拟真实拍摄场景', '1.0.0', 'image', 'image', '{"cpu":5,"gpu":0,"npu":0,"storage":"1GB"}', '{"modeParam":{"name":"处理模式","description":"选择处理模式","type":"select","defaultVal":"all","options":["normal","tilted","shadow","watermark","incomplete","all"],"required":false}}', '', 0, '[{"name":"处理速度","metric":"10 images/sec"}]', false, 'system', 'system'),
...
(
    ...
    '1.0.0', 'text', 'image',
    '{"memory":524288000,"cpu":5,"gpu":0,"storage":"500MB"}',
...
(
    ...
    '1.0.0', 'text', 'text',
    '{"memory":209715200,"cpu":5,"gpu":0,"storage":"200MB"}',
...
(
    ...
    '将合成图片与真实世界背景图片进行融合',
    '1.0.0', 'image', 'image',
    '{"memory": 41943040, "cpu": 5, "gpu": 0, "npu": 0, "storage": "100MB"}',
...
(
    ...
    '1.0.0', 'image', 'image',
    '{"cpu": 5, "gpu": 0, "npu": 0, "storage": "1024MB"}',
...
(
    ...
    '1.0.0', 'text', 'image',
    '{"memory": 10485760, "cpu": 5, "gpu": 0, "npu": 0, "storage": "50MB"}',
    '{
        "templatePath": {
            "name": "模板图路径",
...
(
    ...
    '1.0.0', 'image', 'image',
    '{"memory": 10485760, "cpu": 5, "gpu": 0, "npu": 0, "storage": "1024MB"}',
    '{
        "scenesParam": {
            "name": "场景数量",
...
INSERT INTO t_operator (id, "name", description, "version", inputs, outputs, runtime, settings, file_name, file_size, metrics, is_star, usage_count, created_by, updated_by) VALUES('PropertyWordToImageConverter', '不动产Word转图片', '将Word文档转换为高质量JPG图片，支持多页文档', '1.0.0', 'text', 'image', '{"memory":209715200,"cpu":0.3,"gpu":0,"npu":0,"storage":"100MB"}', '{"maxRetries":{"name":"最大重试次数","description":"Word转PDF失败时的最大重试次数","type":"inputNumber","defaultVal":3,"min":1,"max":5,"step":1,"required":false}}', 'property_info_word_to_image_converter.tar', 31744, '[{"name":"处理速度","metric":"5 docs/sec"}]', NULL, 0, 'system', 'system');
INSERT INTO t_operator (id, "name", description, "version", inputs, outputs, runtime, settings, file_name, file_size, metrics, is_star, usage_count, created_by, updated_by) VALUES('PropertyRealWorldSimulatorMapper', '不动产查询结果真实世界模拟', '将电子凭证图片合成到真实场景中，模拟各种拍摄效果（正常、斜拍、阴影、水印、不完整等场景）', '1.0.0', 'image', 'image', '{"memory":104857600,"cpu":5,"gpu":0.1,"storage":"100MB"}', '{"skipSimulationParam":{"name":"跳过模拟","description":"是否跳过真实世界模拟步骤，直接使用已生成的模拟图片","type":"switch","defaultVal":"false","required":false,"checkedLabel":"跳过","unCheckedLabel":"执行"},"skipDetectParam":{"name":"跳过检测","description":"是否跳过坐标检测，直接使用缓存的坐标信息","type":"switch","defaultVal":"true","required":false,"checkedLabel":"使用缓存","unCheckedLabel":"重新检测"}}', 'property_info_real_world_sim.tar', 37888, '[{"name":"处理速度","metric":"5 images/sec"},{"name":"准确率","metric":"95%"}]', NULL, 0, 'system', 'system');
INSERT INTO t_operator (id, "name", description, "version", inputs, outputs, runtime, settings, file_name, file_size, metrics, is_star, usage_count, created_by, updated_by) VALUES('PropertyQAJsonGeneratorMapper', '不动产查询结果生成QA对', '根据模拟图片和不动产数据，生成问答对格式的JSON文件，支持大模型字段识别', '1.0.0', 'image', 'text', '{"memory":104857600,"cpu":0.1,"gpu":0.0,"storage":"100MB"}', '{"outputFilenameParam":{"name":"输出文件名","description":"生成的JSON文件名","type":"input","defaultVal":"output.json","required":false}}', 'property_info_generate_qa.tar', 54784, '[{"name":"处理速度","metric":"10 records/sec"},{"name":"准确率","metric":"98%"}]', NULL, 0, 'system', 'system');
INSERT INTO t_operator (id, "name", description, "version", inputs, outputs, runtime, settings, file_name, file_size, metrics, is_star, usage_count, created_by, updated_by) VALUES('PropertyDocFillerMapper', '不动产文档生成算子', '将不动产数据填充到Word模板中，生成查询结果文档', '1.0.0', 'text', 'text', '{"memory":134217728,"cpu":0.2,"gpu":0,"npu":0}', NULL, 'property_info_generate_doc.tar', 65536, '[{"name":"生成速度","metric":"10 docs/sec"},{"name":"内存使用","metric":"128MB"}]', NULL, 0, 'system', 'system');
INSERT INTO t_operator (id, "name", description, "version", inputs, outputs, runtime, settings, file_name, file_size, metrics, is_star, usage_count, created_by, updated_by) VALUES('PropertyDataGeneratorMapper', '不动产数据生成算子', '生成不动产信息查询结果数据，包含姓名、身份证、地址、产权信息等', '1.0.0', 'text', 'text', '{"memory":67108864,"cpu":0.1,"gpu":0,"npu":0}', '{"count":{"name":"生成数量","description":"生成不动产数据组数","type":"slider","defaultVal":1,"required":true,"min":1,"max":100,"step":1}}', 'property_info_generate_data.tar', 29184, '[{"name":"生成速度","metric":"100 records/sec"},{"name":"内存使用","metric":"64MB"}]', NULL, 0, 'system', 'system');
INSERT INTO t_operator (id, "name", description, "version", inputs, outputs, runtime, settings, file_name, file_size, metrics, is_star, usage_count, created_by, updated_by) VALUES('PropertySealMapper', '不动产盖章算子', '给不动产查询结果图片添加逼真印章，支持旋转、透明度、磨损、模糊、渐变等效果', '1.0.0', 'image', 'image', '{"memory":5368709120,"cpu":0.5,"gpu":0,"npu":0}', NULL, 'property_info_add_seal.tar', 36352, '[{"name":"处理速度","metric":"10 images/sec"},{"name":"内存使用","metric":"512MB"}]', NULL, 0, 'system', 'system');

INSERT INTO t_operator_category_relation (category_id, operator_id) VALUES('9eda9d5d-072b-499b-916c-797a0a8750e1', 'PropertySealMapper');
INSERT INTO t_operator_category_relation (category_id, operator_id) VALUES('de36b61c-9e8a-4422-8c31-d30585c7100f', 'PropertySealMapper');
INSERT INTO t_operator_category_relation (category_id, operator_id) VALUES('431e7798-5426-4e1a-aae6-b9905a836b34', 'PropertySealMapper');
INSERT INTO t_operator_category_relation (category_id, operator_id) VALUES('96a3b07a-3439-4557-a835-525faad60ca3', 'PropertySealMapper');
INSERT INTO t_operator_category_relation (category_id, operator_id) VALUES('9eda9d5d-072b-499b-916c-797a0a8750e1', 'PropertyDataGeneratorMapper');
INSERT INTO t_operator_category_relation (category_id, operator_id) VALUES('d8a5df7a-52a9-42c2-83c4-01062e60f597', 'PropertyDataGeneratorMapper');
INSERT INTO t_operator_category_relation (category_id, operator_id) VALUES('431e7798-5426-4e1a-aae6-b9905a836b34', 'PropertyDataGeneratorMapper');
INSERT INTO t_operator_category_relation (category_id, operator_id) VALUES('96a3b07a-3439-4557-a835-525faad60ca3', 'PropertyDataGeneratorMapper');
INSERT INTO t_operator_category_relation (category_id, operator_id) VALUES('9eda9d5d-072b-499b-916c-797a0a8750e1', 'PropertyDocFillerMapper');
INSERT INTO t_operator_category_relation (category_id, operator_id) VALUES('d8a5df7a-52a9-42c2-83c4-01062e60f597', 'PropertyDocFillerMapper');
INSERT INTO t_operator_category_relation (category_id, operator_id) VALUES('431e7798-5426-4e1a-aae6-b9905a836b34', 'PropertyDocFillerMapper');
INSERT INTO t_operator_category_relation (category_id, operator_id) VALUES('96a3b07a-3439-4557-a835-525faad60ca3', 'PropertyDocFillerMapper');
INSERT INTO t_operator_category_relation (category_id, operator_id) VALUES('9eda9d5d-072b-499b-916c-797a0a8750e1', 'PropertyQAJsonGeneratorMapper');
INSERT INTO t_operator_category_relation (category_id, operator_id) VALUES('d8a5df7a-52a9-42c2-83c4-01062e60f597', 'PropertyQAJsonGeneratorMapper');
INSERT INTO t_operator_category_relation (category_id, operator_id) VALUES('431e7798-5426-4e1a-aae6-b9905a836b34', 'PropertyQAJsonGeneratorMapper');
INSERT INTO t_operator_category_relation (category_id, operator_id) VALUES('96a3b07a-3439-4557-a835-525faad60ca3', 'PropertyQAJsonGeneratorMapper');
INSERT INTO t_operator_category_relation (category_id, operator_id) VALUES('9eda9d5d-072b-499b-916c-797a0a8750e1', 'PropertyRealWorldSimulatorMapper');
INSERT INTO t_operator_category_relation (category_id, operator_id) VALUES('de36b61c-9e8a-4422-8c31-d30585c7100f', 'PropertyRealWorldSimulatorMapper');
INSERT INTO t_operator_category_relation (category_id, operator_id) VALUES('431e7798-5426-4e1a-aae6-b9905a836b34', 'PropertyRealWorldSimulatorMapper');
INSERT INTO t_operator_category_relation (category_id, operator_id) VALUES('96a3b07a-3439-4557-a835-525faad60ca3', 'PropertyRealWorldSimulatorMapper');
INSERT INTO t_operator_category_relation (category_id, operator_id) VALUES('9eda9d5d-072b-499b-916c-797a0a8750e1', 'PropertyWordToImageConverter');
INSERT INTO t_operator_category_relation (category_id, operator_id) VALUES('d8a5df7a-52a9-42c2-83c4-01062e60f597', 'PropertyWordToImageConverter');
INSERT INTO t_operator_category_relation (category_id, operator_id) VALUES('431e7798-5426-4e1a-aae6-b9905a836b34', 'PropertyWordToImageConverter');
INSERT INTO t_operator_category_relation (category_id, operator_id) VALUES('96a3b07a-3439-4557-a835-525faad60ca3', 'PropertyWordToImageConverter');

INSERT INTO t_operator_release (id, "version", release_date, changelog) VALUES('PropertyWordToImageConverter', '1.0.0', '2026-01-31', '["首次发布","支持Word转JPG图片功能","支持多页文档处理","支持自动跳过空白页","支持图片DPI配置","支持图片路径和Base64编码两种输出格式"]'::json);
INSERT INTO t_operator_release (id, "version", release_date, changelog) VALUES('PropertyRealWorldSimulatorMapper', '1.0.0', '2026-01-31', '["首次发布","支持正常、斜拍、阴影、水印、不完整等多种场景模拟","支持坐标缓存，提高处理效率","支持自动旋转和比例校正"]'::json);
INSERT INTO t_operator_release (id, "version", release_date, changelog) VALUES('PropertyQAJsonGeneratorMapper', '1.0.0', '2026-01-31', '["首次发布","支持从模拟图片生成问答对","支持大模型API识别图片中的字段","支持分页文档处理","支持字段缓存，减少大模型API调用"]'::json);
INSERT INTO t_operator_release (id, "version", release_date, changelog) VALUES('PropertyDocFillerMapper', '1.0.0', '2026-01-31', '["首次发布","支持生成不动产查询结果Word文档"]'::json);
INSERT INTO t_operator_release (id, "version", release_date, changelog) VALUES('PropertyDataGeneratorMapper', '1.0.0', '2026-01-31', '["首次发布","支持生成不动产查询结果数据"]'::json);
INSERT INTO t_operator_release (id, "version", release_date, changelog) VALUES('PropertySealMapper', '1.0.0', '2026-01-31', '["首次发布","支持给图片添加逼真印章效果"]'::json);